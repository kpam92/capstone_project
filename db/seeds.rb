...
Comment.create!(body: "very eery", author_id: 2, photo_id: 10)
...
Comment.create!(body: "love the light in this shot", author_id: 4, photo_id: 9)
...
Comment.create!(body: "love this picture!", author_id: 4, photo_id: 28)
